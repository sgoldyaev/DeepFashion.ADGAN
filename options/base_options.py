...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dirSem', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--no_flip', action='store_false', help='if specified, flip the images for data augmentation')
